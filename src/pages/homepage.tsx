            ...
            <div id="a-tabs" className="">
                ...
                <div className="py-6 md:px-1 md:py-8">
                    ...
                    <div className={`${currentTab !== 3 ? "hidden" : ""}`} id="segment-3" role="tabpanel" aria-labelledby="segment-item-3">
                        ...
                        <div id="a-body" className="flex flex-col-reverse gap-10 h-max md:flex md:flex-row">
                            <div id="b-cam" className="w-full gap-20 flex flex-col md:w-3/12 md:gap-8">
                                <div id="c-cam" className="flex gap-2 md:flex md:flex-col md:gap-10">
                                ...
                                <div id="c-controls" className="grid gap-y-2 px-10 md:grid-cols-4 grid-rows-2 md:gap-y-3 md:px-3">
                                    <div >
                                        <SVGCam />
                                    </div>
                                    <div >
                                    ...
                                    <div className=" col-start-1 col-span-4">
                                        <button type="button" className="py-3 px-16 md:px-24 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-50 text-black hover:bg-blue-100 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                            Leave
